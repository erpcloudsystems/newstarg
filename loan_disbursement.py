...
class CustomLoanDisbursement(AccountsController):
		...
		if self.applicant_type == "Bank":
			gle_map.append(
				self.get_gl_dict({
					...
					"debit_in_account_currency": self.net_loan_amount,
			...
			gle_map.append(
				self.get_gl_dict({
					"account": loan_details.interest_income_account,
			...
			gle_map.append(
				self.get_gl_dict({
					"account": loan_details.administrative_expenses_account,
			...
			gle_map.append(
				self.get_gl_dict({
					"account": loan_details.current_account,
